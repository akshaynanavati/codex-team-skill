...
def run_wrapper_template(team_root: Path) -> str:
    ...
    return (
        ...
        "def resolve_run_mode(forwarded_args: list[str]) -> str:\n"
        "    if \"--train\" in forwarded_args:\n"
        "        return \"train\"\n"
        "    if \"--optimize\" in forwarded_args:\n"
        "        return \"optimize\"\n"
        "    return \"execute\"\n\n"
        "def main() -> int:\n"
        ...
        "    run_mode = resolve_run_mode(forwarded_args)\n"
        ...
        "    if not help_requested and run_mode == \"execute\" and SPECIAL_MEMBER_CHECKS:\n"
        "        try:\n"
